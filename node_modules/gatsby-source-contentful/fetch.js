...
function () {
  var _ref = (0, _asyncToGenerator2.default)(function* (_ref2) {
    let spaceId = _ref2.spaceId,
        ...
        options = (0, _objectWithoutPropertiesLoose2.default)(_ref2, ["spaceId", "syncToken"]);
    // Fetch articles.
    console.time(`Fetch Contentful data`);
    console.log(`Starting to fetch data from Contentful`);
    const client = contentful.createClient(Object.assign({
      space: spaceId
    }, options)); // The sync API puts the locale in all fields in this format { fieldName:
    ...
    try {
      ...
      console.log(`Try running setting GATSBY_CONTENTFUL_OFFLINE=true to see if we can serve from cache.`);
      process.exit(1);
    }
